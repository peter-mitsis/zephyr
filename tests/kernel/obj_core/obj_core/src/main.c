...
ZTEST(obj_core, test_obj_core_thread)
{
	...
	common_obj_core_test(OBJ_TYPE_THREAD_ID, "thread",
	...
	obj_type = k_obj_type_find(OBJ_TYPE_THREAD_ID);
...
{
	common_obj_core_test(OBJ_TYPE_MEM_BLOCK_ID, "memory block",
...
ZTEST(obj_core, test_obj_core_timer)
{
	...
	common_obj_core_test(OBJ_TYPE_TIMER_ID, "timer",
...
ZTEST(obj_core, test_obj_core_stack)
{
	...
	common_obj_core_test(OBJ_TYPE_STACK_ID, "stack",
...
{
	k_fifo_init(&fifo2);
	common_obj_core_test(OBJ_TYPE_FIFO_ID, "FIFO",
...
{
	k_lifo_init(&lifo2);
	common_obj_core_test(OBJ_TYPE_LIFO_ID, "LIFO",
...
ZTEST(obj_core, test_obj_core_pipe)
{
	...
	common_obj_core_test(OBJ_TYPE_PIPE_ID, "pipe",
...
ZTEST(obj_core, test_obj_core_msgq)
{
	...
	common_obj_core_test(OBJ_TYPE_MSGQ_ID, "message queue",
...
{
	k_mbox_init(&mbox2);
	common_obj_core_test(OBJ_TYPE_MBOX_ID, "mailbox",
...
ZTEST(obj_core, test_obj_core_condvar)
{
	...
	common_obj_core_test(OBJ_TYPE_CONDVAR_ID, "condition variable",
...
{
	k_event_init(&event2);
	common_obj_core_test(OBJ_TYPE_EVENT_ID, "event",
...
{
	k_mutex_init(&mutex2);
	common_obj_core_test(OBJ_TYPE_MUTEX_ID, "mutex",
...
ZTEST(obj_core, test_obj_core_sem)
{
	...
	common_obj_core_test(OBJ_TYPE_SEM_ID, "semaphore",
