		  ...
		  uint32_t num_entries)
{
	...
	k_obj_core_link(K_OBJ_CORE(stack));
#endif
}
...
#ifdef CONFIG_OBJ_CORE_STACK
static int init_stack_module(void)
{
	/* Initialize stack object type */

	z_obj_type_init(&obj_type_stack, OBJ_TYPE_STACK_ID,
...
SYS_INIT(init_stack_module, PRE_KERNEL_1,
