...
static int init_fifo_module(void)
{
	/* Initialize fifo object type */

	z_obj_type_init(&_obj_type_fifo, OBJ_TYPE_FIFO_ID,
...
SYS_INIT(init_fifo_module, PRE_KERNEL_1,
...
static int init_lifo_module(void)
{
	/* Initialize lifo object type */

	z_obj_type_init(&_obj_type_lifo, OBJ_TYPE_LIFO_ID,
...
SYS_INIT(init_lifo_module, PRE_KERNEL_1,
	 CONFIG_KERNEL_INIT_PRIORITY_OBJECTS);
#endif
