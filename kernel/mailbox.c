...
void k_mbox_init(struct k_mbox *mbox)
{
	...
	k_obj_core_link(K_OBJ_CORE(mbox));
#endif
...
static int init_mailbox_module(void)
{
	/* Initialize mailbox object type */

	z_obj_type_init(&obj_type_mailbox, OBJ_TYPE_MBOX_ID,
...
SYS_INIT(init_mailbox_module, PRE_KERNEL_1,
