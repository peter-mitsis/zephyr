...
int z_impl_k_mutex_init(struct k_mutex *mutex)
{
	...
	k_obj_core_link(K_OBJ_CORE(mutex));
#endif
...
#ifdef CONFIG_OBJ_CORE_MUTEX
static int init_mutex_module(void)
{
	/* Initialize mutex object type */

	z_obj_type_init(&obj_type_mutex, OBJ_TYPE_MUTEX_ID,
...
SYS_INIT(init_mutex_module, PRE_KERNEL_1,
